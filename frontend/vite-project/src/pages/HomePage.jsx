...
import { CheckCircleIcon, UsersIcon,UserPlusIcon } from 'lucide-react';
import { MapPinIcon } from "lucide-react"; // or your icon library
...
const {data:recommendedUsers=[], isLoading:lodingUsers}=useQuery({
  queryKey: ['users'],
